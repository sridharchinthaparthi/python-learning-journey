...
A comprehensive banking application demonstrating object-oriented programming with multiple account types and transactions.
...
### ⭕ [Tic Tac Toe](https://github.com/sridharchinthaparthi/tic-tac-toe)
...
<details>
<summary><b>Click to expand full syllabus breakdown</b></summary>

### ✅ Fundamentals
- [x] Variables and multi-variable creation
- [x] Data types (int, float, str, list, dict, tuple, set)
- [x] Inbuilt methods of data types
...
### ✅ Database & Data
- [x] SQLite3 connections
- [x] CRUD operations
- [x] SQL queries and joins
- [x] JSON operations
- [x] CSV handling
